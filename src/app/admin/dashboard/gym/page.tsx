...
export default function AdminGymPage() {
  ...
  // Filter products for gym category
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-black/80 max-w-2xl mx-auto">
              Manage your gym equipment and fitness products
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <p className="text-black">
            Showing {gymProducts.length} gym products
          </p>
        </div>
        ...
        {gymProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-black mb-4">
              No products are currently available in the gym category
            </p>
          </div>
        )}
      </div>
