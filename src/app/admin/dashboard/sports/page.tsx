...
export default function AdminSportsPage() {
  ...
  const sportsProducts = allProducts.filter(product => product.category === 'sports');
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-black/80 max-w-2xl mx-auto">
              Manage your sports equipment and gear
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <p className="text-black">
            Showing {sportsProducts.length} sports products
          </p>
        </div>
        ...
        {sportsProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-black mb-4">
              No products are currently available in the sports category
            </p>
          </div>
        )}
      </div>
