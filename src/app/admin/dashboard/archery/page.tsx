...
export default function AdminArcheryPage() {
  ...
  // Filter products for archery category
  const archeryProducts = allProducts.filter(product => product.category === 'archery');
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-black/80 max-w-2xl mx-auto">
              Manage your archery equipment and accessories
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <p className="text-black">
            Showing {archeryProducts.length} archery products
          </p>
        </div>

        {/* Products Grid */}
        {archeryProducts.length > 0 ? (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {archeryProducts.map((product) => (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-black mb-4">
              No products are currently available in the archery category
            </p>
          </div>
        )}
      </div>
