...
export default function AdminCampingPage() {
  ...
  // Filter products for camping category
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-black/80 max-w-2xl mx-auto">
              Manage your camping gear and outdoor equipment
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <p className="text-black">
            Showing {campingProducts.length} camping products
          </p>
        </div>
        ...
        {campingProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-black mb-4">
              No products are currently available in the camping category
            </p>
          </div>
        )}
      </div>
